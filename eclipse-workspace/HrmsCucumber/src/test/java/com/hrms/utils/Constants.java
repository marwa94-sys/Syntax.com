...
public class Constants {
    ...
    //The path of properties file, xfile, drivers, reports ----->Reading the path of property File 
				...
				public static final String TESTDATA_FILEPATH=System.getProperty("user.dir")+"\\src\\test\\resources\\testdata\\hrms.xlsx";
				
				public static final String REPORT_FILEPATH=System.getProperty("user.dir")+"\\target\\html-report\\HRMS.html";
				
				public static final String SCHREENSHOT_FILEPATH=System.getProperty("user.dir")+"\\screenshot\\";
