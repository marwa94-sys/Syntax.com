...
public class CommonMethods  extends PageInitializer{
   ...
   //Method will dismiss Alert and catches exception if Alert in not present 
	...
	//Method that Sends text of Alert and catches exception  if alert is not present 
		...
		public static void jsClick(WebElement loginBtn) {
			getJSObject().executeScript("arguments[0].click();", loginBtn);
		}
		...
		*/
		...
		public static String takeScreenShot(String filename) {
		    ...
		    String destinationFile=Constants.SCHREENSHOT_FILEPATH+filename+getTimeStamp()+".png";
		      try {
